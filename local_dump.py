...
def get_args():
    ...
    parser.add_argument('--metadata_dir', default='/home/jinhyuk/models/bert')
    parser.add_argument('--data_dir', default='/home/jinhyuk/data/covid-19/preprocessed/2020-03-19/dump')
    parser.add_argument('--data_name', default='BioASQ')
    parser.add_argument('--load_dir', default='/home/jinhyuk/models/KR94373_piqa-nfs_1173')
